...
public class ZViewPagerChangeListener implements OnPageChangeListener {
    ...
    public interface ILOnPageScrollStateChanged {
         ...
         *
         * @param state ：滑动状态，使用{@link ZViewPagerChangeListener.State}
         */
