...
public class ZMessage implements Parcelable {
    ...
    private Map<?, ?> map;
    public static final Creator<ZMessage> CREATOR = new Creator<ZMessage>() {

        @Override
        public ZMessage createFromParcel(Parcel source) {
        ...
        @Override
        public ZMessage[] newArray(int size) {
            return new ZMessage[size];
        }
