...
public class PackageUtils {
     ...
     * @return
     */
    public static boolean checkIsInstall(Context ctx, String pkgName) {
     ...
     * @param pkgName
     */
    public static void execApp(Context ctx, String pkgName) {
    ...
    public static String getImsi(Context ctx) {
        TelephonyManager teleMgr = (TelephonyManager) ctx.getSystemService(Context.TELEPHONY_SERVICE);// 取得相关系统服务
