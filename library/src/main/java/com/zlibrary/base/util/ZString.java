...
public class ZString {
     ...
     * @return
     */
    public static String byte2Mb(int size) {
        DecimalFormat fmt = new DecimalFormat("0.00");
        return fmt.format(size / 1024.00 / 1024.00);
    }
     ...
     *
     * @param String      判断字符串
     * @param containStrs 用,分割的字符数组
     * @return
     */
    public static boolean StringHasStr(String String, String containStrs) {
        boolean isExist = false;
        if (!isEmpty(String) && !isEmpty(containStrs)) {
            for (String s : containStrs.split(",")) {
