...
public final class ZDBHelper extends SQLiteOpenHelper {
    ...
    private static ZDBHelper mDataProvider;
    private SQLiteDatabase myDataBase;
    private String[] mTableCreateText;
    private String[] mTableDropText;

    private ZDBHelper(Context context, String databaseName, int databaseVersion) {
     ...
     * @return
     */
    public static synchronized ZDBHelper Instance(Context context,
                                                  String databaseName, int databaseVersion) {
        if (mDataProvider == null) {
            mDataProvider = new ZDBHelper(context, databaseName,
                    databaseVersion);
        }
    ...
    public SQLiteCursor Query(String SQL) {
        ...
        SQLiteCursor cursor = (SQLiteCursor) myDataBase
                .rawQuery(SQL, null);
        return cursor;
    }
     ...
     * 查询
     */
    public SQLiteCursor getCursor(String TableName,
        ...
        return (SQLiteCursor) myDataBase.query(
